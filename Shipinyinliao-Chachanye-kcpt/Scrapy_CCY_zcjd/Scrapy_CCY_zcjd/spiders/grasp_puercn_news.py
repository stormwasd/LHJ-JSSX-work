import scrapy
from Scrapy_CCY_zcjd.items import ScrapyCcyZcjdItem
...
class GraspPuercnNewsSpider(scrapy.Spider):
    name = 'grasp_puercn_news'
    ...
    def start_requests(self):
        for i in range(1, 2):
            url = f"https://www.puercn.com/news/guandian/p{i}/"
...
if __name__ == '__main__':
    ...
    cmd.execute(['scrapy', 'crawl', 'grasp_puercn_news'])
