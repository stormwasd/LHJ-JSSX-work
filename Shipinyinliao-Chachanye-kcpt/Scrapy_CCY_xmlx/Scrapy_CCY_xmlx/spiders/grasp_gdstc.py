import json
import scrapy
from Scrapy_CCY_xmlx.items import ScrapyCcyXmlxItem
...
class GraspGdstcSpider(scrapy.Spider):
    ...
    def start_requests(self, *args, **kwargs):
        for i in range(1, 2):
            url = f'http://sjfb.gdstc.gd.gov.cn/sjfb/api/project/listProjectInitial?size=10&current={i}&projectName=%E8%8C%B6'
            req = scrapy.Request(
                url,
                callback=self.parse,
                dont_filter=True,
