import scrapy
import json
from Scrapy_SCGY_cgzh.items import ScrapyScgyCgzhItem
...
class GraspNjgcttSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for i in range(1, 2):
            url = f'http://www.njgctt.com/search/tec/?p={i}&q=%e7%9f%b3%e6%9d%90'
    ...
    def parse_detail(self, response):
        ...
        item = ScrapyScgyCgzhItem()
        item['news_id'] = news_id  # id（url哈希值)
        item['category'] = '建筑雕饰'  # 行业
        item['sub_category'] = '石材工业产业'  # 行业子类
