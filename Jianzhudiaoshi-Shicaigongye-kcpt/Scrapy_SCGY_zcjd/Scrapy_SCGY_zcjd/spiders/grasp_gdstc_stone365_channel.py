import scrapy
from Scrapy_SCGY_zcjd.items import ScrapyScgyZcjdItem
...
class GraspStone365Spider(scrapy.Spider):
    name = 'grasp_stone365_channel'
    allowed_domains = ['www.stone365.com']
    start_urls = ['https://www.stone365.com/news/channel-39-1.html']
    headers = {
...
if __name__ == '__main__':
    ...
    cmd.execute(['scrapy', 'crawl', 'grasp_stone365_channel'])
