import scrapy
from Scrapy_SCGY_zcdt.items import ScrapyScgyZcdtItem
...
class GraspStone365Spider(scrapy.Spider):
    name = 'grasp_stone365_news'
    allowed_domains = ['www.stone365.com']
    start_urls = ['https://www.stone365.com/news/channel-1-1.html']
    headers = {
...
if __name__ == '__main__':
    ...
    cmd.execute(['scrapy', 'crawl', 'grasp_stone365_news'])
