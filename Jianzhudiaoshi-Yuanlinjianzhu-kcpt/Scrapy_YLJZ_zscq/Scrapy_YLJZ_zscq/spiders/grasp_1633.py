import scrapy
from Scrapy_YLJZ_zscq.items import ScrapyYljzZscqItem
...
class Grasp1633Spider(scrapy.Spider):
    ...
    def start_requests(self):
        for i in range(1, 2):
            url = f'https://www.1633.com/patent/0/0/{i}/?keyword=%E5%9B%AD%E6%9E%97%E5%BB%BA%E7%AD%91'
