...
import scrapy
import json
from Scrapy_YLZJ_xmsb.items import ScrapyYlzjXmsbItem
...
class GraspGdstcSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for i in range(1, 2):
            url = f'http://sjfb.gdstc.gd.gov.cn/sjfb/api/project/listPlanDeclare?size=10&current={i}&name=%E5%9B%AD%E6%9E%97'
            req = scrapy.Request(
                url,
                callback=self.parse,
                dont_filter=True,
