...
import scrapy
import json
from Scrapy_LHJ_xmys.items import ScrapyLhjXmysItem


class LhjXmysSpider(scrapy.Spider):
    name = 'lhj_xmys'
    ...
    def start_requests(self):
        for i in range(1, 2):
            url = f'http://sjfb.gdstc.gd.gov.cn/sjfb/api/project/listTPlanCheck?size=10&current={i}&projectName=%E5%AE%B6%E5%85%B7'
...
if __name__ == '__main__':
    ...
    cmd.execute(['scrapy', 'crawl', 'lhj_xmys'])