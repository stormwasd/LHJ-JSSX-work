...
class UploadInfo(scrapy.Spider):
    ...
    def __init__(*args,**kwargs):
        ...
        collection = db['lhj_kcpt_xmys']  # 获取collection
        url_info = 'http://192.168.0.11:10020/dataApp/sciencePlatform/addList/accept'
        count = 0
...
if __name__ == '__main__':
    ...
    cmdline.execute('scrapy crawl xmys-uploadinfo'.split())
