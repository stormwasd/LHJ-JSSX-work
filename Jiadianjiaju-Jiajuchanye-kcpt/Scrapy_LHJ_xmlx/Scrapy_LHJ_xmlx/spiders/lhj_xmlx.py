...
import scrapy
from Scrapy_LHJ_xmlx.items import ScrapyLhjXmlxItem



class LhjXmlxSpider(scrapy.Spider):
    name = 'lhj_xmlx'
    ...
    def start_requests(self):
        for i in range(1, 2):
            url = f'http://sjfb.gdstc.gd.gov.cn/sjfb/api/project/listProjectInitial?size=10&current={i}&projectName=%E5%AE%B6%E5%85%B7'
    ...
    def parse(self, response):
        ...
        for i in jso:
            ...
            country = '中国'
            indic_name = '家具产业'
            issue_time = i.get('beginYear') + '-12-9'

            item = ScrapyLhjXmlxItem()
...
if __name__ == '__main__':
    ...
    cmd.execute(['scrapy', 'crawl', 'lhj_xmlx'])