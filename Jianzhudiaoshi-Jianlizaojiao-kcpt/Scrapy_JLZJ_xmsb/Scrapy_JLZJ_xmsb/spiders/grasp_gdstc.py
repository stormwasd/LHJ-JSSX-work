...
import scrapy
import json
from Scrapy_JLZJ_xmsb.items import ScrapyJlzjXmsbItem
...
class GraspGdstcSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for i in range(1, 2):
            url = f'http://sjfb.gdstc.gd.gov.cn/sjfb/api/project/listPlanDeclare?size=10&current={i}&name=%E7%9B%91%E7%90%86'
            req = scrapy.Request(
                url,
                callback=self.parse,
                dont_filter=True,
