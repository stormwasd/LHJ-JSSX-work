import scrapy
from Scrapy_JLZJ_qbzx.items import ScrapyJlzjQbzxItem
...
class GraspChinairnSpider(scrapy.Spider):
    ...
    start_urls = [
        'https://www.chinairn.com/searchnew.aspx?search=%E7%9B%91%E7%90%86&Bigid=4&Key=&btnSeach=']
    ...
    def start_requests(self):
        for i in range(1, 2):
            url = f'https://www.chinairn.com/searchnew.aspx?Keyword=%e7%9b%91%e7%90%86&PageId={i}'
