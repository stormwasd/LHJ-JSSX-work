...
import scrapy
import json
from Scrapy_YCCY_xmsb.items import ScrapyYccyXmsbItem
...
class GraspGdstcSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for i in range(1, 2):
            url = f'http://sjfb.gdstc.gd.gov.cn/sjfb/api/project/listPlanDeclare?size=10&current={i}&name=%E7%83%9F%E8%8D%89'
            req = scrapy.Request(
                url,
                callback=self.parse,
                dont_filter=True,
