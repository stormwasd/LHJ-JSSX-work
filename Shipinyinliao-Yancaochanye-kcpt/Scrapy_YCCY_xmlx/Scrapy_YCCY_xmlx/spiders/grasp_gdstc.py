import json
import scrapy
from Scrapy_YCCY_xmlx.items import ScrapyYccyXmlxItem
...
class GraspGdstcSpider(scrapy.Spider):
    ...
    def start_requests(self, *args, **kwargs):
        for i in range(1, 2):
            url = f'http://sjfb.gdstc.gd.gov.cn/sjfb/api/project/listProjectInitial?size=10&current={i}&projectName=%E7%83%9F%E8%8D%89'
            req = scrapy.Request(
                url,
                callback=self.parse,
                dont_filter=True,
