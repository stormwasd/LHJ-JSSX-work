import json
import scrapy
from Scrapy_DS_xmlx.items import ScrapyDsXmlxItem
...
class GraspGdstcSpider(scrapy.Spider):
    ...
    def start_requests(self, *args, **kwargs):
        for i in range(1, 2):
            url = f'http://sjfb.gdstc.gd.gov.cn/sjfb/api/project/listProjectInitial?size=10&current={i}&projectName=%E9%9B%95%E5%A1%91'
            req = scrapy.Request(
                url,
                callback=self.parse,
                dont_filter=True,
