...
import scrapy
import json
from Scrapy_DS_xmsb.items import ScrapyDsXmsbItem
...
class GraspGdstcSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for i in range(1, 2):
            url = f'http://sjfb.gdstc.gd.gov.cn/sjfb/api/project/listPlanDeclare?size=10&current={i}&name=%E9%9B%95%E5%A1%91'
            req = scrapy.Request(
                url,
                callback=self.parse,
                dont_filter=True,
