...
class GraspGovSpider(scrapy.Spider):
    ...
    def start_requests(self):
        url = "http://www.quyang.gov.cn/xxgkcontent-1006-61086.html"
    ...
    def parse(self, response):
        ...
        content = ''.join(response.xpath("//div[@id='scroll-area']").extract())
        ...
        item['information_source'] = '曲阳县人民政府信息公开'
...
if __name__ == '__main__':
    ...
    cmd.execute(['scrapy', 'crawl', 'grasp_quyang'])