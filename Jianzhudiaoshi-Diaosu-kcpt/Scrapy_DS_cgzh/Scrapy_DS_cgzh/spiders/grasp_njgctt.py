import scrapy
import json
from Scrapy_DS_cgzh.items import ScrapyDsCgzhItem
...
class GraspNjgcttSpider(scrapy.Spider):
    name = 'grasp_njgctt'
    allowed_domains = ['http://www.njgctt.com/']
    start_urls = ['http://http://www.njgctt.com//']
    ...
    def start_requests(self):
        for i in range(1, 2):
            url = f'http://www.njgctt.com/search/tec/?p={i}&q=%e9%9b%95%e5%a1%91'
