import scrapy
from Scrapy_DS_zscq.items import ScrapyDsZscqItem
...
class Grasp1633Spider(scrapy.Spider):
    ...
    start_urls = [
        'https://www.1633.com/patent/0/0/1/?keyword=%E9%9B%95%E5%A1%91']

    def start_requests(self):
        for i in range(1, 3):
            url = f'https://www.1633.com/patent/0/0/{i}/?keyword=%E9%9B%95%E5%A1%91'
