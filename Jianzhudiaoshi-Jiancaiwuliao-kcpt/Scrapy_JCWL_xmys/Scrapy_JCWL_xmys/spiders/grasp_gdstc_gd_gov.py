...
import scrapy
import json
from Scrapy_JCWL_xmys.items import ScrapyJcwlXmysItem
...
class GraspGdstcGdGovSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for i in range(1, 2):
            url = f'http://sjfb.gdstc.gd.gov.cn/sjfb/api/project/listTPlanCheck?size=10&current={i}&projectName=%E5%BB%BA%E6%9D%90'
