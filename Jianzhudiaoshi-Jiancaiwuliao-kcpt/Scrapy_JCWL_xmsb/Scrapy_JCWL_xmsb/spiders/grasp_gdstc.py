...
import scrapy
import json
from Scrapy_JCWL_xmsb.items import ScrapyJcwlXmsbItem
...
class GraspGdstcSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for i in range(1, 2):
            url = f'http://sjfb.gdstc.gd.gov.cn/sjfb/api/project/listPlanDeclare?size=10&current={i}&name=%E5%BB%BA%E6%9D%90'
